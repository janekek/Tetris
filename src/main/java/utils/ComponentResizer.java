...
public class ComponentResizer extends MouseAdapter
{
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current)
    {
        ...
        Button.updateButtonsBounds();
        DrawStartMenu.enterGameButton = new RoundRectangle2D.Float(Utils.getCentralX()-175, Utils.getCentralY()-25, 350, 50, 10, 10);
        DrawStartMenu.changeGameModeButton = new Rectangle(Gui.width/2+190, Gui.height/2+55, 20,40);
        DrawStartMenu.changeTheme = new Rectangle(Gui.width/2+190, Gui.height/2-95, 20,40);
    }
